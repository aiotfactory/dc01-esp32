...
void define_user_config(void)
{
    ...
    define_number_variable(MODULE_GENERAL,CONFIG_UPLOAD_INTERVAL_SECONDS,"upload_interval_seconds",60,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    define_number_variable(MODULE_GENERAL,CONFIG_UPLOAD_RETRY_TIMES,"upload_retry_times",60,sizeof(uint8_t),0,CONFIG_NUMBER_NORMAL,2,1,20);
    define_number_variable(MODULE_GENERAL,CONFIG_UPLOAD_TIMEOUT_SECONDS,"upload_timeout_seconds",30,sizeof(uint8_t),0,CONFIG_NUMBER_NORMAL,2,10,300);
    define_number_variable(MODULE_GENERAL,CONFIG_KEEP_ALIVE_IDLE,"keep_alive_idle",60,sizeof(uint16_t),CONFIG_FLAG_RECONN,CONFIG_NUMBER_NORMAL,2,0,86400);
    define_number_variable(MODULE_GENERAL,CONFIG_KEEP_ALIVE_CNT,"keep_alive_cnt",3,sizeof(uint8_t),CONFIG_FLAG_RECONN,CONFIG_NUMBER_NORMAL,2,1,10);
    define_number_variable(MODULE_GENERAL,CONFIG_KEEP_ALIVE_INTERVAL,"keep_alive_interval",10,sizeof(uint8_t),CONFIG_FLAG_RECONN,CONFIG_NUMBER_NORMAL,2,1,120);
    define_number_variable(MODULE_GENERAL,CONFIG_WORK_START,"work_start",0000,sizeof(uint16_t),0,CONFIG_NUMBER_NORMAL,2,0,2400);
    define_number_variable(MODULE_GENERAL,CONFIG_WORK_END,"work_end",2400,sizeof(uint16_t),0,CONFIG_NUMBER_NORMAL,2,0,2400);
    define_number_variable(MODULE_GENERAL,CONFIG_NO_COMMUNICATE_SECONDS,"no_communicate_seconds",1800,sizeof(uint32_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    define_number_variable(MODULE_META,CONFIG_META_ONOFF,"meta_onoff",1,sizeof(uint8_t),0,CONFIG_NUMBER_ENUM,2,0,1);
    define_number_variable(MODULE_META,CONFIG_META_UPLOAD_INTERVAL_SECONDS,"meta_upload_interval_seconds",100,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);    
    ...
    define_number_variable(MODULE_ADC_BAT,CONFIG_ADC_BAT_UPLOAD_INTERVAL_SECONDS,"adc_bat_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);  
    ...
    define_number_variable(MODULE_LORA,CONFIG_LORA_TX_OUTPUT_POWER,"lora_tx_power",2,sizeof(uint8_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,0,22);
    ...
    define_number_variable(MODULE_LORA,CONFIG_LORA_UPLOAD_INTERVAL_SECONDS,"lora_upload_interval_seconds",50,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff); 
    ...
    define_number_variable(MODULE_UART,CONFIG_UART_UPLOAD_INTERVAL_SECONDS,"uart_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_GPIO,CONFIG_GPIO_UPLOAD_INTERVAL_SECONDS,"gpio_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_TM7705,CONFIG_TM7705_UPLOAD_INTERVAL_SECONDS,"tm7705_upload_interval_seconds",2,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_CAMERA,CONFIG_CAMERA_UPLOAD_INTERVAL_SECONDS,"camera_upload_interval_seconds",20,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    define_number_variable(MODULE_CAMERA,CONFIG_CAMERA_SIZE,"camera_size",10,sizeof(uint8_t),0,CONFIG_NUMBER_NORMAL,2,0,21);
    define_number_variable(MODULE_CAMERA,CONFIG_CAMERA_QUALITY,"camera_quality",30,sizeof(uint8_t),0,CONFIG_NUMBER_NORMAL,2,0,63);
    ...
    define_number_variable(MODULE_W5500,CONFIG_W5500_MODE,"w5500_mode",0,sizeof(uint8_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_ENUM,4,0,1,2,3);
    ...
    define_number_variable(MODULE_CONFIG,CONFIG_CONFIG_UPLOAD_INTERVAL_SECONDS,"config_upload_interval_seconds",200,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_FORWARD,CONFIG_FORWARD_UPLOAD_INTERVAL_SECONDS,"forward_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_AHT20,CONFIG_AHT20_UPLOAD_INTERVAL_SECONDS,"aht20_upload_interval_seconds",30,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_SPL06,CONFIG_SPL06_UPLOAD_INTERVAL_SECONDS,"spl06_upload_interval_seconds",50,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
    ...
    define_number_variable(MODULE_RS485,CONFIG_RS485_UPLOAD_INTERVAL_SECONDS,"rs485_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,1,0xffffffff);
