...
void define_user_config(void)
{
    ...
    define_number_variable(MODULE_META,CONFIG_META_ONOFF,"meta_onoff",0,sizeof(uint8_t),0,CONFIG_NUMBER_ENUM,2,0,1);
    ...
    define_number_variable(MODULE_ADC_BAT,CONFIG_ADC_BAT_UPLOAD_INTERVAL_SECONDS,"adc_bat_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);  
    ...
    define_number_variable(MODULE_LORA,CONFIG_LORA_TX_OUTPUT_POWER,"lora_tx_power",3,sizeof(uint8_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,0,3);
    ...
    define_number_variable(MODULE_LORA,CONFIG_LORA_UPLOAD_INTERVAL_SECONDS,"lora_upload_interval_seconds",50,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff); 
    ...
    define_number_variable(MODULE_UART,CONFIG_UART_UPLOAD_INTERVAL_SECONDS,"uart_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_GPIO,CONFIG_GPIO_UPLOAD_INTERVAL_SECONDS,"gpio_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_TM7705,CONFIG_TM7705_UPLOAD_INTERVAL_SECONDS,"tm7705_upload_interval_seconds",2,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_CAMERA,CONFIG_CAMERA_UPLOAD_INTERVAL_SECONDS,"camera_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_CONFIG,CONFIG_CONFIG_UPLOAD_ONOFF,"config_upload_onoff",0,sizeof(uint8_t),0,CONFIG_NUMBER_ENUM,2,0,1);
    define_number_variable(MODULE_CONFIG,CONFIG_CONFIG_UPLOAD_INTERVAL_SECONDS,"config_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_FORWARD,CONFIG_FORWARD_UPLOAD_INTERVAL_SECONDS,"forward_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_AHT20,CONFIG_AHT20_UPLOAD_INTERVAL_SECONDS,"aht20_upload_interval_seconds",5,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_SPL06,CONFIG_SPL06_UPLOAD_INTERVAL_SECONDS,"spl06_upload_interval_seconds",5,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_RS485,CONFIG_RS485_UPLOAD_INTERVAL_SECONDS,"rs485_upload_interval_seconds",1,sizeof(uint32_t),0,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_PIR,CONFIG_PIR_UPLOAD_INTERVAL_SECONDS,"pir_upload_interval_seconds",1000,sizeof(uint32_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_THERMAL,CONFIG_THERMAL_UPLOAD_INTERVAL_SECONDS,"thermal_upload_interval_seconds",1,sizeof(uint32_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
    ...
    define_number_variable(MODULE_ULTRASONIC,CONFIG_ULTRASONIC_UPLOAD_INTERVAL_SECONDS,"ultrasonic_upload_interval_seconds",5,sizeof(uint32_t),CONFIG_FLAG_REBOOT,CONFIG_NUMBER_NORMAL,2,0,0xffffffff);
