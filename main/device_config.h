...
/**
 * 定义配置项的类型。
 * Define the types of configuration items.
 */
...
typedef enum {
    ...
    CONFIG_UPLOAD_INTERVAL_SECONDS,
    CONFIG_UPLOAD_RETRY_TIMES,
    CONFIG_UPLOAD_TIMEOUT_SECONDS,
    CONFIG_KEEP_ALIVE_IDLE,
    CONFIG_KEEP_ALIVE_CNT,
    CONFIG_KEEP_ALIVE_INTERVAL,
    CONFIG_NO_COMMUNICATE_SECONDS,
